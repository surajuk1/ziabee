  ...
  <div class="col-md-12">
    ...
    <div class="col-md-4">
      ...
      <ul class="list-unstyled">
        ...
        <?php } ?>
        <li><a href="<?php echo $return; ?>/add"><?php echo $text_return; ?></a></li>
        <?php if(false) { ?><li><a href="<?php echo $transaction; ?>"><?php echo $text_transaction; ?></a></li>
        <li><a href="<?php echo $recurring; ?>"><?php echo $text_recurring; ?></a></li><?php } ?>
      </ul>
    </div>
