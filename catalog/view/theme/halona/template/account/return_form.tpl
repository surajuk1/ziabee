      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" style="text-align:center;" for="input-firstname"><?php echo $entry_firstname; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" style="text-align:center;" for="input-lastname"><?php echo $entry_lastname; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" style="text-align:center;" for="input-telephone"><?php echo $entry_telephone; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" style="text-align:center;" for="input-order-id"><?php echo $entry_order_id; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" style="text-align:center;" for="input-date-ordered"><?php echo $entry_date_ordered; ?></label>
            <div class="col-sm-3">
        ...
        <fieldset>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" style="text-align:center;" for="input-product"><?php echo $entry_product; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" style="text-align:center;" for="input-model"><?php echo $entry_model; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" style="text-align:center;"><?php echo $entry_reason; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" style="text-align:center;"><?php echo $entry_opened; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" style="text-align:center;" for="input-comment"><?php echo $entry_fault_detail; ?></label>
            <div class="col-sm-10">
