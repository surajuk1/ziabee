...
$wish_count = $theme_options->getWish(); ?>
<div id="wish_block">
	
	<div class="cart-heading" onclick="window.location.href = '<?php echo $wish; ?>'">
		<i class="material-icons">favorite</i>
		<?php if($wish_count>0):?>
		<i class="wish-count"><span id="total_count_wish_ajax"><?php echo $wish_count; ?></span></i>
		<?php else:?>
		<i class="wish-count" style="display: none;"><span id="total_count_wish_ajax"><?php echo $wish_count; ?></span></i>
		<?php endif;?>
	</div>
</div>
<!-- Cart block -->
<div id="cart_block" class="dropdown">
	<div class="cart-heading dropdown-toogle" data-hover="dropdown" data-toggle="dropdown" onclick="window.location.href = '<?php echo $cart; ?>'">
		<?php if($cart_info['total_item']>0):?>
		<i class="cart-count"><span id="total_count_ajax"><?php echo $cart_info['total_item']; ?></span></i>
		<?php else:?>
		<i class="cart-count" style="display: none;"><span id="total_count_ajax"><?php echo $cart_info['total_item']; ?></span></i>
		<?php endif;?>
		...
		<?php } else { ?>
		<i class="cart-box material-icons"></i>
