...
class ModelCatalogCategory extends Model {
	...
	public function getCategoryBanner($category_id) {
		//die("SELECT * FROM " . DB_PREFIX . "category_image WHERE category_id = '" . (int)$category_id . "'");
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "category_image WHERE category_id = '" . (int)$category_id . "'");

		return $query->rows;
	}

	public function getSubCategoryBanner($category_id) {
		//die("SELECT * FROM " . DB_PREFIX . "category WHERE parent_id = '" . (int)$category_id . "'");
