...
class ModelToolExportImport extends Model {
	...
	protected function validateProducts( &$reader ) {
		...
		$expected_heading = array
		( "product_id", "name", "categories", "sku");
		// if (in_array("ean",$product_fields)) {
		...
		// }
		if ($this->use_table_seo_url) {
			$expected_heading = array_merge( $expected_heading, array( "quantity", "model", "manufacturer", "image_name", "shipping", "price", "date_added", "date_modified", "date_available", "weight", "weight_unit", "length", "width", "height", "length_unit", "status",  "description") );
		} else {
			$expected_heading = array_merge( $expected_heading, array( "quantity", "model", "manufacturer", "image_name", "shipping", "price", "date_added", "date_modified", "date_available", "weight", "weight_unit", "length", "width", "height", "length_unit", "status",  "seo_keyword", "description") );
		}
		if ($exist_meta_title) {
