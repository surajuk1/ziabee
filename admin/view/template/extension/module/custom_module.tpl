							...
							<div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
							  <div class="block<?php echo $module_row; ?>" <?php if (2 == $module['type']) { echo 'style="display:none"'; } ?>>
								  <table class="form">
								    ...
								    <tr>
								      <td>Block content:</td>
								      <td><textarea name="custom_module_module[<?php echo $module_row; ?>][block_content][<?php echo $language['language_id']; ?>]" id="block-content-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['block_content'][$language['language_id']]) ? $module['block_content'][$language['language_id']] : ''; ?></textarea></td>
								    </tr>
								  </table>	
							  </div>
							  <div class="html<?php echo $module_row; ?>" <?php if (2 != $module['type']) { echo 'style="display:none"'; } ?>>
								  <table class="form">
								    <tr>
								      <td>HTML:</td>
								      <td><textarea name="custom_module_module[<?php echo $module_row; ?>][html][<?php echo $language['language_id']; ?>]" class="html"><?php echo isset($module['html'][$language['language_id']]) ? $module['html'][$language['language_id']] : ''; ?></textarea></td>
								    </tr>
								  </table>
							  </div>
							</div>
							...
							<table class="form">
							  ...
							  <tr>
							    ...
							    <td><select name="custom_module_module[<?php echo $module_row; ?>][position]">
						     	...
						     	<?php } ?>
						     	<?php if ($module['position'] == 'top_block') { ?>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		html += '				<td><textarea name="custom_module_module[' + module_row + '][block_content][<?php echo $language['language_id']; ?>]" id="block-content-' + module_row + '-<?php echo $language['language_id']; ?>"></textarea></td>';
		html += '			</tr>';
		html += '	   </table>';
		html += '	 </div>';
		...
		html += '        <tr>';
		html += '          <td>HTML:</td>';
		html += '          <td><textarea name="custom_module_module[' + module_row + '][html][<?php echo $language['language_id']; ?>]" class="html"></textarea></td>';
		html += '        </tr>';
		html += '      </table>';
		html += '	  </div>';
