						...
						<div id="tab-module-<?php echo $module_row; ?>" class="tab-content">
							<div class="input clearfix">
								...
								<div class="list-language">
									...
									<div class="language">
										<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" width="16px" height="11px" />
								...
								<div id="carousel-<?php echo $module_row; ?>-element-<?php echo $i; ?>" style="padding-top:20px">
									...
									<div id="tab-language-<?php echo $module_row; ?>-<?php echo $i; ?>-<?php echo $language['language_id']; ?>">
										<div class="input-with-editor clearfix">
											<textarea rows="0" cols="0" name="carousel_item_module[<?php echo $module_row; ?>][items][<?php echo $i; ?>][<?php echo $language['language_id']; ?>][html]" id="carousel_item_<?php echo $module_row; ?>_<?php echo $i; ?>_<?php echo $language['language_id']; ?>_html"><?php if(isset($item[$lang_id]['html'])) { echo $item[$lang_id]['html']; } ?></textarea>
											<script type="text/javascript">
												$('#carousel_item_<?php echo $module_row; ?>_<?php echo $i; ?>_<?php echo $language['language_id']; ?>_html').summernote({
													height: 300
												});
											</script>
										</div>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		html += '				<img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" width="16px" height="11px" />';
...
function addElement(module_row) {
	...
	html += '			<textarea rows="0" cols="0" name="carousel_item_module['+ module_row +'][items][' + elements + '][<?php echo $language['language_id']; ?>][html]" id="carousel_item_'+ module_row +'_' + elements + '_<?php echo $language['language_id']; ?>_html"></textarea>';
	html += '		</div>';
	html += '    </div>';
	<?php } ?>
	html += '</div>';
	...
	<?php foreach ($languages as $language) { ?>
		$('#carousel_item_'+ module_row +'_' + elements + '_<?php echo $language['language_id']; ?>_html').summernote({
			height: 300
		});
	<?php } ?>
