								...
								<?php $module_row = 0; if($modules != '') { ?>
									...
									<tbody id="module<?php echo $module_row; ?>">
										<tr>
											...
											<td>
												<?php if(isset($module['slider_align_top'])) { ?>
													<?php if($module['slider_align_top'] == 0 && $module['slider_align_top'] != '') { echo '<div class="status status-off" title="0" rel="module_'.$module_row.'_slider_align_top"></div>'; } else { echo '<div class="status status-on" title="1" rel="module_'.$module_row.'_slider_align_top"></div>'; } ?>
												<?php } else { echo '<div class="status status-off" title="0" rel="module_'.$module_row.'_slider_align_top"></div>'; } ?>
												<input name="revolution_slider_module[<?php echo $module_row; ?>][slider_align_top]" value="<?php if(isset($module['slider_align_top'])) { echo $module['slider_align_top']; } else { echo '0'; } ?>" id="module_<?php echo $module_row; ?>_slider_align_top" type="hidden" />
											</td>
											<td>
